...
import info.fingo.xactus.processor.internal.types.XSByte;
...
import info.fingo.xactus.processor.internal.types.XSEntity;
import info.fingo.xactus.processor.internal.types.XSFloat;
import info.fingo.xactus.processor.internal.types.XSGDay;
import info.fingo.xactus.processor.internal.types.XSGMonth;
import info.fingo.xactus.processor.internal.types.XSGMonthDay;
import info.fingo.xactus.processor.internal.types.XSGYear;
import info.fingo.xactus.processor.internal.types.XSGYearMonth;
...
import info.fingo.xactus.processor.internal.types.XSInt;
import info.fingo.xactus.processor.internal.types.XSInteger;
import info.fingo.xactus.processor.internal.types.XSLong;
import info.fingo.xactus.processor.internal.types.XSNCName;
import info.fingo.xactus.processor.internal.types.XSNMTOKEN;
import info.fingo.xactus.processor.internal.types.XSName;
import info.fingo.xactus.processor.internal.types.XSNegativeInteger;
...
import info.fingo.xactus.processor.internal.types.XSNotation;
import info.fingo.xactus.processor.internal.types.XSPositiveInteger;
import info.fingo.xactus.processor.internal.types.XSShort;
import info.fingo.xactus.processor.internal.types.XSString;
import info.fingo.xactus.processor.internal.types.XSTime;
import info.fingo.xactus.processor.internal.types.XSToken;
import info.fingo.xactus.processor.internal.types.XSUnsignedByte;
import info.fingo.xactus.processor.internal.types.XSUnsignedInt;
import info.fingo.xactus.processor.internal.types.XSUnsignedLong;
import info.fingo.xactus.processor.internal.types.XSUnsignedShort;
