...
public abstract class NodeType extends AnyType {
	...
	public static info.fingo.xactus.processor.ResultSequence eliminate_dups(info.fingo.xactus.processor.ResultSequence rs) {
	...
	public static ResultSequence sort_document_order( info.fingo.xactus.processor.ResultSequence rs )
	{
