...
import info.fingo.xactus.processor.internal.XPathError;
...
public class BuiltinTypeDefinition implements AtomicTypeDefinition  {
	...
	/* (non-Javadoc)
	 * @see info.fingo.xactus.processor.internal.types.builtin.AtomicTypeDefinition#construct(info.fingo.xactus.api.ResultSequence)
	 */
