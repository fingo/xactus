...
public class FsPlus extends Function {
	...
	private static Collection convert_args(Collection args) throws DynamicError {
		...
		for (Iterator i = args.iterator(); i.hasNext();) {
			info.fingo.xactus.api.ResultSequence rs = FnData.atomize((info.fingo.xactus.api.ResultSequence) i.next());
		...
		if (has_double || has_float) {
			...
			for (Iterator i = result.iterator(); i.hasNext();) {
				info.fingo.xactus.api.ResultSequence rs = (info.fingo.xactus.api.ResultSequence) i.next();
	...
	public static ResultSequence do_math_op(Collection args, Class type,
		...
		Item arg = ((info.fingo.xactus.api.ResultSequence) argi.next()).item(0);
		info.fingo.xactus.api.ResultSequence arg2 = (info.fingo.xactus.api.ResultSequence) argi.next();
