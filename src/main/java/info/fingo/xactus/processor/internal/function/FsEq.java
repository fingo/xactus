...
//			b = converted.first();
	...
	public static ResultSequence do_cmp_general_op(Collection args, Class type,
		...
		info.fingo.xactus.api.ResultSequence one = (info.fingo.xactus.api.ResultSequence) argiter.next();
		info.fingo.xactus.api.ResultSequence two = (info.fingo.xactus.api.ResultSequence) argiter.next();
