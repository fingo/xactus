...
public class NilledFuncTest extends AbstractPsychoPathTest {
   ...
   public void test_fn_nilled_1() throws Exception {
      ...
      String xqFile = "/Queries/XQuery/Functions/AccessorFunc/NilledFunc/fn-nilled-1.xq";
      String resultFile = "/ExpectedTestResults/Functions/AccessorFunc/NilledFunc/fn-nilled-1.txt";
   ...
   public void test_fn_nilled_2() throws Exception {
      ...
      String xqFile = "/Queries/XQuery/Functions/AccessorFunc/NilledFunc/fn-nilled-2.xq";
      String resultFile = "/ExpectedTestResults/Functions/AccessorFunc/NilledFunc/fn-nilled-2.txt";
      String expectedResult = getExpectedResult(resultFile);
      URL fileURL = bundle.getEntry(inputFile);
      loadDOMDocument(fileURL);
   ...
   public void test_fn_nilled_3() throws Exception {
      String inputFile = "/TestSources/works-mod.xml";
      String xqFile = "/Queries/XQuery/Functions/AccessorFunc/NilledFunc/fn-nilled-3.xq";
      String resultFile = "/ExpectedTestResults/Functions/AccessorFunc/NilledFunc/fn-nilled-3.txt";
      String expectedResult = getExpectedResult(resultFile);
      URL fileURL = bundle.getEntry(inputFile);
      loadDOMDocument(fileURL);
