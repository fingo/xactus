...
public class NodeNameFuncTest extends AbstractPsychoPathTest {

   //Evaluates the "node-name" function with argument set to empty sequence.
   public void test_fn_node_name_1() throws Exception {
      String inputFile = "/TestSources/emptydoc.xml";
      String xqFile = "/Queries/XQuery/Functions/AccessorFunc/NodeNameFunc/fn-node-name-1.xq";
      String resultFile = "/ExpectedTestResults/Functions/AccessorFunc/NodeNameFunc/fn-node-name-1.txt";
